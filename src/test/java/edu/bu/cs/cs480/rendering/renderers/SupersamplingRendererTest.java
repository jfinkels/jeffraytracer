...
import edu.bu.cs.cs480.rendering.supersampling.GridAverager;
...
public class SupersamplingRendererTest {
  ...
  /**
   * Test method for
   * {@link edu.bu.cs.cs480.rendering.renderers.SupersamplingRenderer#generatePrimaryRays()}
   * .
   */
  @Test
  ...
  /**
   * Test method for
   * {@link edu.bu.cs.cs480.rendering.renderers.SupersamplingRenderer#postProcessing(edu.bu.cs.cs480.Vector3D[])}
   * .
   */
  @Test
